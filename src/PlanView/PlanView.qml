...
Item {
    ...
    onStackViewStatusChanged: {
        if (stackViewStatus == StackView.Activating) {
            ...
            if (!_planMasterController.containsItems) {
                ...
                selectPlanDialogComponent.createObject(ApplicationWindow.window).open()
            }
    ...
    Component {
        id: selectPlanDialogComponent

        SelectPlanDialog { planMasterController: _planMasterController}
    }
    ...
    Item {
        ...
        FlightMap {
            ...
            property rect centerViewport:   Qt.rect(_leftToolWidth + _margin,  _margin, editorMap.width - _leftToolWidth - _rightToolWidth - (_margin * 2), (terrainPanel.visible ? terrainPanel.y : height - _margin) - _margin)
